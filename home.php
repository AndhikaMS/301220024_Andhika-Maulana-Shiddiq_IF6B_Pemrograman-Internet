...
<head>
    ...
    <style>
        ...
        .menu { flex: 1; }
        .menu-item { display: flex; align-items: center; padding: 12px 24px; color: #ff8800; background: #fff7f0; border-left: 4px solid #ff8800; font-weight: bold; text-decoration: none; }
...
<div class="layout">
    <div class="sidebar">
        ...
        <div class="menu">
            <div class="menu-item" style="color:#ff8800; background:#fff7f0; border-left:4px solid #ff8800;">
