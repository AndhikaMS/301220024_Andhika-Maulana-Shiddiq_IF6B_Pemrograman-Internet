...
<head>
    <meta charset="UTF-8">
    <title>Tambah Postingan - Tumbuh Lestari</title>
    <style>
...
<div class="layout">
    ...
    <div style="flex:1;display:flex;flex-direction:column;">
        ...
        <div class="content">
            <form class="form-card" method="post" action="blog_tambah_proses.php">
                <div class="form-header">
                    <a href="blog.php" style="text-decoration:none;color:#888;font-size:22px;">&#8592;</a>
                    <div class="form-title">Tambah Postingan</div>
                </div>
                <div class="form-desc">Tambahkan detail postingan blog</div>
                <div class="form-group">
                    <label class="form-label">Judul</label>
                    <input type="text" name="judul" class="form-input" placeholder="Judul Postingan" required>
                </div>
                <div class="form-group">
                    <label class="form-label">Konten</label>
                    <textarea name="konten" class="form-textarea" placeholder="Tulis sesuatu..." required></textarea>
                </div>
