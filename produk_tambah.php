...
<head>
    <meta charset="UTF-8">
    <title>Tambah Produk - Tumbuh Lestari</title>
    <style>
...
<div class="layout">
    ...
    <div style="flex:1;display:flex;flex-direction:column;">
        ...
        <div class="content">
            <form class="form-card" method="post" action="produk_tambah_proses.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nama" class="form-input" placeholder="Product Name" required>
                </div>
                <div class="form-group">
                    <label class="form-label">Harga</label>
                    <input type="number" name="harga" class="form-input" placeholder="10000" required>
                </div>
                <div class="form-group">
                    <label class="form-label">Link Shopee</label>
                    <input type="url" name="link_shopee" class="form-input" placeholder="https://shopee.co.id/produk">
                </div>
                <div class="form-group">
                    <label class="form-label">Deskripsi</label>
                    <textarea name="deskripsi" class="form-textarea" placeholder="Product Description"></textarea>
                </div>
                <div class="form-group">
